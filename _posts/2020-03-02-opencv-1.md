...
```
![사진](/assets/Anaconda1-11.png)

실행해주면 다음과 같이 opencv 버전이 잘 나오는 것을 확인할 수 있다.

![사진](/assets/Anaconda1-12.png)
